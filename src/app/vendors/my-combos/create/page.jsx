  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors flex flex-col">
      <div className="lg:max-w-6xl mx-auto w-full flex-1 p-3 lg:p-0 pb-10">
        ...
        <div className="mb-6 bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 p-3 rounded border border-white/5 shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 relative overflow-hidden group">
          {/* Brand Accent Glow */}
        ...
        <div className={`transition-all duration-500 ${isLastStep ? 'max-w-4xl mx-auto' : 'grid grid-cols-1 lg:grid-cols-12 gap-3'}`}>
          ...
          <div className={`${isLastStep ? 'col-span-full' : 'lg:col-span-8'} space-y-4`}>
            <div className="bg-white dark:bg-zinc-900/70 backdrop-blur-xl rounded p-3 border border-zinc-200 dark:border-zinc-800 min-h-[500px] relative overflow-hidden transition-all shadow-xl shadow-black/5 [&_.p-4]:p-3 [&_.p-5]:p-3 [&_.p-6]:p-3 [&_.p-8]:p-3 [&_.px-4]:px-3 [&_.px-5]:px-3 [&_.px-6]:px-3 [&_.px-8]:px-3 [&_.py-4]:py-3 [&_.py-5]:py-3 [&_.py-6]:py-3 [&_.py-8]:py-3 [&_.rounded-2xl]:rounded [&_.rounded-3xl]:rounded">
      ...
      {/* STICKY FOOTER */}
      <div className="sticky bottom-0 z-40 w-full p-3 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-t border-zinc-100 dark:border-zinc-800 mt-auto">
