                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
                                        <label className="flex cursor-pointer items-center justify-between gap-4">
                                            <span><span className="block text-[10px] font-black uppercase tracking-widest text-zinc-800 dark:text-white">Track stock</span><span className="mt-1 block text-[9px] font-medium text-zinc-400">Stops orders when this choice reaches zero.</span></span>
                                            <input type="checkbox" checked={optionTrackStock} onChange={e => setOptionTrackStock(e.target.checked)} className="h-5 w-5 accent-orange-600" />
                                        </label>
